...
function! CommentLine()
  ...
  " for .cpp or .hpp or .java or .C or gmsh/.geo files use or netcdf metadata .cdl //
  if file_name =~ '\.cpp$' || file_name =~ '\.cdl$' || file_name =~ '\.geo$' || file_name =~ '\.hpp$' || file_name =~ '\.java$' || file_name =~ '\.php[2345]\?$' || file_name =~ '\.C$'
...
function! UnCommentLine()
  ...
  " for .cpp or gmsh/.geo .hpp or .java or .C files use //
  if file_name =~ '\.cpp$' || file_name =~ '\.cdl$' || file_name =~ '\.geo$' || file_name =~ '\.hpp$' || file_name =~ '\.java$' || file_name =~ '\.php[2345]\?$' || file_name =~ '\.C$'
...
function! RangeCommentLine()
  ...
  " for .cpp or .hpp or .java or .geo .C files use //
  if file_name =~ '\.cpp$' || file_name =~ '\.cdl$' || file_name =~ '\.geo$' || file_name =~ '\.hpp$' || file_name =~ '\.java$' || file_name =~ '\.php[2345]\?$' || file_name =~ '\.C$'
...
function! RangeUnCommentLine()
  ...
  " for .cpp or .hpp or .java or .geo files use //
  if file_name =~ '\.cpp$' || file_name =~ '\.cdl$' ||  file_name =~ '\.geo$' || file_name =~ '\.hpp$' || file_name =~ '\.java$' || file_name =~ '\.php[2345]\?$' || file_name =~ '\.C$'
